---
title: "Retinal Detachment Surgery in Tirur - Sampada VR Speciality Eye Care"
h1: "Retinal Detachment Treatment in Tirur"
description: "Retinal detachment is an emergency. Symptoms, how it is diagnosed, and the surgical options available at Sampada VR Speciality Eye Care in Tirur, Kerala."
...
faqs:
  - q: "How quickly does retinal detachment need to be treated?"
    a: "It should be assessed the same day. Surgery is usually arranged within days, and sooner if the central vision is still intact, because the aim is to reattach the retina before the macula is involved."
  - q: "What are the warning signs?"
    a: "A sudden increase in floaters, flashes of light, or a dark curtain or shadow moving across part of your vision. Any of these warrants an urgent examination, even if vision still seems normal."
  - q: "Will my vision come back completely?"
    a: "It depends chiefly on whether the macula, the central part of the retina, had detached before surgery and for how long. If the macula was still attached, the outlook is usually good. If not, some central vision is often permanently reduced."
  - q: "Is the surgery done under general anaesthesia?"
    a: "Many retinal detachment operations are performed under local anaesthesia, though general anaesthesia is used in some cases. Your surgeon will discuss which applies to you."
  - q: "Why do I have to lie in a particular position after surgery?"
    a: "When a gas bubble is used to hold the retina in place, posturing keeps the bubble against the area that needs support. It is uncomfortable but it materially affects the outcome."
  - q: "Can the retina detach again?"
    a: "It can, which is why follow-up matters. Report any return of flashes, new floaters or a shadow in your vision without waiting for a scheduled appointment."
---
...
**Vitrectomy** removes the vitreous gel, drains the fluid under the retina, treats the breaks, and fills the eye with gas or silicone oil to hold the retina in place while it heals. See our page on [vitrectomy surgery](/treatments/vitrectomy/) for how the operation itself works.
