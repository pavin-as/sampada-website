---
title: "Intravitreal Injections in Tirur - Eye Injections for Retina | Sampada VR"
h1: "Intravitreal Injections in Tirur"
description: "Anti-VEGF and steroid eye injections for macular degeneration, diabetic macular oedema and retinal vein occlusion at Sampada VR Speciality Eye Care, Tirur, Kerala."
...
faqs:
  - q: "Does an eye injection hurt?"
    a: "The eye is numbed with anaesthetic drops or gel before the injection, and the needle used is very fine. Most patients report pressure rather than pain. Some grittiness or a red patch on the white of the eye afterwards is common and settles."
  - q: "Will I be awake? Can I see the needle?"
    a: "You are awake, but you will not see the needle clearly. The eye is held open and you will be asked to look in a particular direction. The injection itself takes a few seconds."
  - q: "How many injections will I need?"
    a: "Rarely just one. Most conditions need a loading course followed by ongoing treatment at intervals set by how your retina responds, judged on OCT scans. Your surgeon will explain the expected schedule for your condition."
  - q: "Can I drive home afterwards?"
    a: "No. Vision in the treated eye is blurred for some hours and the pupil is often dilated. Arrange for someone to travel with you."
  - q: "What should I watch for after the injection?"
    a: "Increasing pain, worsening redness, growing sensitivity to light or a drop in vision over the following days are not expected. Contact the clinic promptly if any of these occur rather than waiting."
  - q: "What happens if I skip or delay doses?"
    a: "Treatment works by suppressing leakage continuously. Gaps allow fluid and abnormal vessels to return, and vision lost during a lapse may not be fully recovered. Keeping the schedule is the part of the treatment that is in the patient's hands."
---
...
- **Diabetic macular oedema** — swelling at the macula from [diabetic retinopathy](/treatments/diabetic-retinopathy-treatment/), the commonest cause of central vision loss in diabetic patients
